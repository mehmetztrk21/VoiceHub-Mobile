...
import { Dimensions, Image, KeyboardAvoidingView, Modal, Text, TextInput, TouchableOpacity, View, TouchableWithoutFeedback } from "react-native";
    ...
    <KeyboardAvoidingView style={editProfileStyle.container}>
      ...
      <Modal visible={openProfilePhotoPopUp}
        ...
        <ProfilePhotoPopUp navigation={navigation} setOpenProfilePhotoPopUp={setOpenProfilePhotoPopUp}
          setImage={setImage} title={"EditProfile"} setShowAlert={setShowAlert} setAlertMessage={setAlertMessage} />
      </Modal>
